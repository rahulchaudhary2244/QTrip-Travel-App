...
describe("Adventure Page Tests", function () {
  ...
  it("getDurationParameters() - Retrieves number array of size 2 when correct input is passed", () => {
    const data = getDurationParameters("2-16");
    expect(data).toBeInstanceOf(Array);
    expect(data).toEqual([2, 16]);
  });

  it("getDurationParameters() - Retrieves [-Infinity, Infinity] as array of size 2 when incorrect input is passed", () => {
    let data = getDurationParameters("2-");
    expect(data).toBeInstanceOf(Array);
    expect(data).toEqual([-Infinity, Infinity]);

    data = getDurationParameters("2-3-4");
    expect(data).toBeInstanceOf(Array);
    expect(data).toEqual([-Infinity, Infinity]);

    data = getDurationParameters("2-2,");
    expect(data).toBeInstanceOf(Array);
    expect(data).toEqual([-Infinity, Infinity]);
  });
});
